...
<body style="
    ...
    background-image: url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOpmNAjuDHXbWr3_rtdTfjDhC272_yQFyP4g&usqp=CAU);
 ...
 <div  align="center" >
  ...
  <div class="form-group" style="width: 30%">
    <label for="exampleInputEmail1"><h1 style="color: #111;">User Id</h1></label>
  ...
  <div class="form-group" style="width:30%">
    <label for="exampleInputPassword1"><h1 style="color: #111;">Password</h1></label>
